<%@ Page Language="VB" MasterPageFile="~/WebForms/Main.Master" AutoEventWireup="false" Inherits="START_Website.WebForms_JuegosForm" title="Start - Juegos" Codebehind="JuegosForm.aspx.vb" %>
<%@ Register src="../UControls/InventarioUC.ascx" tagname="InventarioUC" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<span class="LetraFormateadaNegra"><span class="LetraFormateada">J</span>uegos</span>
